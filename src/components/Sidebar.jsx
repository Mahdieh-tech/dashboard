...
export default function Sidebar() {
  return (
    <aside
      dir="rtl"
      className="w-64 h-screen bg-white border-r border-gray-100 shadow-sm flex flex-col justify-between rounded-l-2xl fixed top-0 right-0"
    >
      <div>
        {/* Logo */}
...
function SidebarItem({ icon, label, active }) {
  return (
    <button
      className={`flex flex-row-reverse items-center gap-3 w-full px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-200
        ${active

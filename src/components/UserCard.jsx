...
export default function UserInfoCard({ name, role, phone, id, image }) {
  return (
    <div
      dir="rtl"
      className="bg-white/90 backdrop-blur-md border border-gray-200 rounded-2xl shadow-md p-6 w-full max-w-xs flex flex-col items-center text-center transition-transform hover:-translate-y-1 hover:shadow-lg"
    >
      {/* Profile Image */}
